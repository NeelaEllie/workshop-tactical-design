...
public class TacticaldesignApplication {
    ...
    public static void main(String[] args) {
        ...
        Vorschlag vorschlag1 = vorschlagService.erstelleNeuenVorschlag();
        Vorschlag vorschlag2 = vorschlagService.erstelleNeuenVorschlag();

        vorschlagService.validiereVorschlag(vorschlag1.getVorgangId());
    }
